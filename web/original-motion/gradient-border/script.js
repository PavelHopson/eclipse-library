import { GUI } from '../vendor/1d4c38488ce3d48121ed.js';
import Color from '../vendor/0a076aa66ba1a8da86c3.js';
import gsap from '../vendor/49910cdff059df6e60dc.js';
import React from '../vendor/1a19ec86e729557c3929.js';
import { render } from '../vendor/1b80f1f596976c80dc82.js';
...
const App = () => {
  ...
  React.useEffect(() => {
    ...
    name('Прозрачность иконки').
    onChange(SYNC_STYLES);
    sceneFolder.current.
    add(CONFIG, 'movement', 0, 200, 1).
    name('Сдвиг иконки (px)').
    onChange(SYNC_STYLES);
  ...
  return /*#__PURE__*/(
    ...
    cards.map((card, index) => {
      ...
      return /*#__PURE__*/(
        ...
        React.createElement("span", null, "Фон")), /*#__PURE__*/

        React.createElement("div", { className: "dummy__border" }, /*#__PURE__*/
        React.createElement("span", null, "Маска рамки")), /*#__PURE__*/

        React.createElement("div", { className: "dummy__glow" }, /*#__PURE__*/
        React.createElement("span", null, "Маска блика"))) :
        ...
        card.control ? /*#__PURE__*/React.createElement("span", { "data-glow": true }) : null, "Подписаться"))),
