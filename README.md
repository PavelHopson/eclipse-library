...
В каталоге находок можно выбрать задачу или проект, а затем открыть карточку:
...
лицензии, доверию и проекту раскрываются только когда нужны. Фильтр актуальности отделяет
