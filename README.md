...
| [Dark-Moon (ASCIT31)](https://github.com/ASCIT31/Dark-Moon) | Открытая (GPL-3.0) платформа автономного пентеста на базе ИИ. Self-hosted, разворачивается локально, работает как MCP-сервер. Покрывает веб, API, Active Directory и Kubernetes. Ключевая особенность, локальный Privacy Gateway, который прячет чувствительные данные от LLM через детерминированные плейсхолдеры. Dual-use, применять только в рамках авторизованного пентеста и аудита собственной инфраструктуры. | [![Stars](https://img.shields.io/github/stars/ASCIT31/Dark-Moon?style=flat)](https://github.com/ASCIT31/Dark-Moon) |
