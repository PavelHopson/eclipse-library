...
- 534 уникальные записи доступны пользователям.
- 84 карточки прошли ручную редакторскую проверку.
- 450 карточек честно помечены как `inferred` и ожидают углублённого review.
