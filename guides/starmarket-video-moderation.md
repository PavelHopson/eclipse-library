# 🎬 Авто-модерация видео-обзоров Eclipse Market (видео-классификаторы) — POC
...
>
> **Куда ложится:** Eclipse Market видео-обзоры товара — у нас уже есть пайплайн
> загрузки (ffmpeg → 720p/60с → HTML5). Модерация цепляется **после транскода**,
> до промоута в публикацию. ⚠️ Eclipse Market ведёт **другой чат** — это рецепт/референс,
...
## Куда встроить в Eclipse Market (когда дойдут руки в том чате)
